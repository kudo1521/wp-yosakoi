...
<div class="top-wrapper">
    ...
    <main class="main">
        ...
        <section class="admission">
            <p>上記の募集要項等を確認の上、入部を希望される方は杏葉公式ツイッターのDMよりご連絡願います。<br>
                後日、担当より面談の日時に関するご連絡を差し上げますので、日程調整の上面談を行います。<br>
                面談の際に、より詳細なチームの規約や守ってほしいルール事項・チームの展望などを説明しますので、<br class="pc">
                それを踏まえて最終的に入部するかどうかを判断してください。<br>
                面談を行ったからと言って必ず入部しなければならないものではありませんので、杏葉のことを詳しく知りたいと<br class="pc">
                いった方は遠慮なくご連絡ください。また、随時公式ツイッターのDMの方でご質問にお答えしますので、<br class="pc">
                面談をするほどはないが、気になるから教えてほしいといったご質問でも遠慮なくどうぞ。<br>
